...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            if (!(cm.getJobId()==410 ||cm.getJobId()==420||cm.getJobId()==430)) { 
            ...
            if (cm.isQuestCompleted(100102)){ // 三转问答完成
                ...
                cm.dispose();
            } else if ((cm.getJobId()==410 ||cm.getJobId()==420) &&cm.getLevel() >= 70) {// 准备三转
            ...
            if (cm.isQuestCompleted(100102)) { // 转职任务都完成了
                if (cm.getJobId()==410) {
                    ...
                    cm.sendOk("恭喜你，成功转职为了#r无影人#k！");
                    cm.dispose();
                } else if (cm.getJobId()==420) {
                    cm.changeJobById(421);
                    cm.getPlayer().gainAp(5);
                    cm.sendOk("恭喜你，成功转职为了#r独行客#k！");
                    cm.dispose();
                }
