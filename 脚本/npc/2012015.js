...
function start() {
    if (cm.haveItem(4001019))
        cm.sendYesNo("你可以使用 #b#t4001019##k 来激活 #b#p2012014##k。你想传送到 #b#p2012015##k 所在地么？");
    else {
        cm.sendOk("#b#p2012015##k 激活后可以把你传送到 #b#p2012014##k 所在地， 但是如果你没有#b#t4001019##k是没有办法激活它的！");
        cm.dispose();
    }
}
