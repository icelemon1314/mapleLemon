...
import handling.vo.recv.PacketErrorRecvVO;
import tools.StringUtil;
import tools.data.input.SeekableLittleEndianAccessor;

public class PacketErrorHandler extends MaplePacketHandler<PacketErrorRecvVO> {

    public void handlePacket(PacketErrorRecvVO recvVO, MapleClient c) {
