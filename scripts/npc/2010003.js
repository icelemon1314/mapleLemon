...
function action(mode, type, selection) {
    if (mode == 1)
        ...
        cm.dispose();
    if (status == 0 && mode == 1) {
        var selStr = "Hi，你找我有事么？ 我是天空之城最顶尖的手套制作高手，需要我帮你打造点什么么？#b"
        var options = new Array("打造战士手套","打造弓箭手手套","打造魔法师手套","打造飞侠手套");
        ...
        if (selectedType == 0){ //warrior glove
            var selStr = "战士手套？ 好吧，你想打造哪个：#b";
            var gloves = new Array ("青铜暗影手套#k - 需要等级：70#b","锂矿暗影手套#k - 需要等级：70#b","黑暗影手套#k - 需要等级：70#b",
                "马尔斯蓝拳套#k - 需要等级：80#b","马尔斯绿拳套#k - 需要等级：80#b","马尔斯红拳套#k - 需要等级：80#b","马尔斯黑拳套#k - 需要等级：80#b");
